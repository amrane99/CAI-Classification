# CAI-Classification
In a surgical environment it is important to keep track of the phase of the operation. An important indicator of phase is the kind of tools, which are present. This repository offers a tool for computer-assisted interventions (CAI) classification based on Cholec80 video recordings of surgical operations. 
